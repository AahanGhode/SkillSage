...
import '../../public/outlined.css';
export { Example, All } from './storybook';
declare const _default: {
    title: string;
    component: <C extends import("react").ElementType<any>>(props: import("..").PolymorphicMaterialSymbolProps<C>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
    argTypes: {
        icon: {
            control: string;
